    ...
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col justify-center gap-8 px-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          Alpha Engine(AI 크립토 자동매매 엔진) 구독 기반 네트워크 마케팅 — 직접추천/후원 두 계보도, 대실적·기타소실적 집계 프로토타입.
        </p>
      </div>
      <div className="grid gap-4 sm:grid-cols-2">
        <Link href="/marketer/dashboard" className="rounded-xl border bg-card p-6 transition-colors hover:bg-muted">
          <h2 className="text-lg font-semibold">마케터 홈 →</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            요약 카드(대실적/기타소실적), 직접추천·후원 계보도, 레퍼럴 코드.
          </p>
        </Link>
        <Link href="/admin/dashboard" className="rounded-xl border bg-card p-6 transition-colors hover:bg-muted">
